...
$mysqli=conectar(1);
   session_start();
    if(isset($_SESSION["usuario"]))
        {
        $modulos = $mysqli->query("SELECT * FROM crr_users where id=".$id);
      ...
      <div class="register-box-body">
        ...
        <form action="../../Functions/funciones_generales.php" method="get">
          <div class="form-group has-feedback">
            <input type="text" class="form-control" value="<?php echo utf8_decode($file['usuario']); ?>" required name="user" placeholder="usuario">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
          <div class="form-group has-feedback">
            <input type="email" class="form-control" value="<?php echo utf8_decode($file['correo']); ?>" required name="mail" placeholder="correo">
          ...
          <div class="form-group has-feedback">
            ...
            <select name="tipo">
              ...
              <option selected="selected" value="3">Colaborador</option>
