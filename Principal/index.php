    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>ERP</b>SH</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>ERP</b>Shoes</span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      ...
                      <small><?php 
                      echo ConvetidorFechas(date('YYYY-MM-DD'),3); ?></small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
        ...
        title="Cambiar Imagen de <?php echo $_SESSION["usuario"]; ?>">Cambiar Imagen</a>
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="../exit.php" class="btn btn-default btn-flat">Salir</a>
                    </div>
                  </li>
                </ul>
              </li>
...
if ($mysqli->multi_query($query)) {
    ...
    crr_estados_modulos em
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2016 <a href="#">ERP SHOES</a>.</strong> All rights reserved.
      </footer>
